...
const About = () => {
  ...
  return (
    <>
      ...
      {/* Main About Section */}
      <section className="min-h-screen bg-white text-black px-6 py-4 flex flex-col md:flex-row gap-8 items-start justify-between">
        <motion.div
        ...
        >
          ...
          <div className="space-y-4 pt-4">
            {[
              ...
              { label: "Cinematography", percent: 80 },
              { label: "Film Making", percent: 75 },
            ].map(({ label, percent }) => (
